...
PS
{
	...
	float4 MainPs( PixelInput i ) : SV_Target0
	{
		...
		float4 l_1 = Tex2DS( g_tTexture_ps_1, g_sSampler1, i.vTextureCoords.xy );
		float4 l_2 = Tex2DS( g_tTexture_ps_2, g_sSampler1, i.vTextureCoords.xy );
